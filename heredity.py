...
def normalize(probabilities):
    ...
    for person in probabilities:
        s1 = 0
        for i in range(3):
            s1 += probabilities[person]["gene"][i]
        for i in range(3):
            probabilities[person]["gene"][i] /= s1
        s2 = probabilities[person]["trait"][True] + probabilities[person]["trait"][False]
        probabilities[person]["trait"][True] /= s2
        probabilities[person]["trait"][False] /= s2
